...
filedir =""
root_dir = "/mnt/c/Gns3Projects/AR-18-19/ar-1819/project-files/dynamips"  # path to the root directory to search
for root, dirs, files in os.walk(root_dir, onerror=None):  # walk the root dir
    for filename in files:  # iterate over the files in the current dir
        ...
        try:
            ...
            pass
searchprahse = "\\AR-18-19\\ar-1819\\project-files\\dynamips\\"
almostthere=""
...
finalstring = almostthere.split(":")[-1][:-2]+"\\configs"
print(finalstring)
filedir =""
